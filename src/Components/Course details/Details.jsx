...
const Details = () => {
    ...
    return (
        ...
        <div ref={ref} className="flex flex-col max-w-2xl p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-100 dark:text-gray-100 mx-auto my-10">
            <div className="flex space-x-4 justify-between cursor-pointer">
                ...
                <Pdf targetRef={ref} filename="code-example.pdf">
                    {({toPdf}) => <button onClick={toPdf} className='flex gap-2 text-gray-100 bg-red-400 hover:bg-red-500 px-3 shadow-md shadow-gray-500 rounded'>
                        <p className='uppercase text-md'>Download pdf</p>
                        <AiOutlineDownload className='w-6 h-6 text-gray-200'></AiOutlineDownload>
                    </button>}
                </Pdf>
